...
Settings
fortg/chat.lua
ec09b49 24 minutes ago
@GSRMOHAMMAD GSRMOHAMMAD Rename plugins/Chat.lua to chat.lua
266 lines (251 sloc) 6.13 KB
...
Settings
fortg/Chat.lua
6f191a0 27 seconds ago
@GSRMOHAMMAD GSRMOHAMMAD Create Chat.lua
234 lines (228 sloc) 5.74 KB
...
if msg.text == "محمد" and is_sudo(msg) then
	return
end
if msg.text == "mohammad" and is_sudo(msg) then
	return
end
if msg.text == "Mohammad" and is_sudo(msg) then
	return
